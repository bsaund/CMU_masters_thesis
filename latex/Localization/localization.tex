...
\centering
\begin{tikzpicture}
  \node (img) {\includegraphics[width=3in, clip, trim=1.5in 3.3in 1.5in 3.3in]{./Localization/translational_error}};
  \node[left=of img, node distance=0cm, rotate=90, anchor=center,yshift=-1cm] 
       {Translational Error (cm)};
\end{tikzpicture}
\begin{tikzpicture}
  \node (img) {\includegraphics[width=3in, clip, trim=1.5in 3.3in 1.5in 3.3in]{./Localization/rotational_error}};
  \node[left=of img, node distance=0cm, rotate=90, anchor=center,yshift=-1cm] 
