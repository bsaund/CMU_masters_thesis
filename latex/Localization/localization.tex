...
\begin{figure}
  ...
  \end{subfigure}
  \caption{
    Visualization of the belief of the pose of all sections of the part. The green cylinder is the important section to localize and is defined in space through offsets from the top, right, and front faces.\\
